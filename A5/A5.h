...
class Stack{
    private:
        Node<T> *currptr;   
        long long si;                                   //stores the size of the stack
    ...
    public:
        ...
        long long size();                               //command to get the size of the stack
        void print();                                   //prints stack in reverse manner
};

long long convert_string_to_int(string x);              //converts numerical string to int
